...
@section('body')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-24">User Send</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title mb-4 text-center">User Send</h1>
                    ...
                    <form action="{{route('user.dashboard.user.send')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-9">
                                <div>
                                    <button type="submit" class="btn btn-primary w-md">Send to User</button>
                                </div>
                            </div>
                        </div>
                    </form>
